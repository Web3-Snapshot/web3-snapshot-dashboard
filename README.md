...
3. **Generate SSL Certificates**:
   ```bash
   /opt/web3-snapshot/scripts/manage-certificate.sh
   ```
...
- Script: `/opt/web3-snapshot/scripts/manage-certificate.sh`
...
- `scripts/manage-certificate.sh` - SSL certificate generation/renewal
